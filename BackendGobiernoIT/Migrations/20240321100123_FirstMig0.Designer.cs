...
namespace BackendGobiernoIT.Migrations
{
    ...
    [Migration("20240321100123_FirstMig0")]
    partial class FirstMig0
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.Requirement", b =>
                {
                    ...
                    b.Property<Guid?>("DocumentDescriptorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DocumentDescriptorId");
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.TableData", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "TableDataConditionalFilters",
                            Create = "Create",
                            Delete = "Delete",
                            Export = "Export",
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.TableDataAttributes", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -11,
                            AttributeType = "onClick:splitScreenOverlay?TableDataScreen",
                            ColumnsAffected = "*",
                            TableId = "TableData"
                        },
                        new
                        {
                            Id = -12,
                            AttributeType = "onClick:splitScreenOverlay?TableDataConditionalFiltersScreen",
                            ColumnsAffected = "*",
                            TableId = "TableDataConditionalFilters"
                        },
                        new
                        {
                            Id = -1001,
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.TableDataButtons", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ButtonName = "new",
                            Image = "plus",
                            OnClick = "splitScreenOverlay?TableDataConditionalFiltersScreen"
                        },
                        new
                        {
                            TableId = "Companies",
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.TableDataConditionalFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("_TableDataConditionalFilters");
                });
            ...
            modelBuilder.Entity("BackendCore.Lib.Models.Requirement", b =>
                {
                    b.HasOne("BackendCore.Lib.Models.FileDescriptor", "DocumentDescriptor")
                        .WithMany()
                        .HasForeignKey("DocumentDescriptorId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("DocumentDescriptor");
            ...
            modelBuilder.Entity("BackendGobiernoIT.Models.CompanyUser", b =>
                {
                    ...
                    b.HasOne("BackendGobiernoIT.Models.CompanyUser", "MainUser")
                        .WithMany()
                        .HasForeignKey("MainUserId1")
                        .OnDelete(DeleteBehavior.NoAction);
