...
namespace BackendGobiernoIT.Migrations
{
    ...
    [Migration("20240129134026_CambioEnInvSoftware")]
    partial class CambioEnInvSoftware
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendGobiernoIT.Models.Backup", b =>
                {
                    ...
                    b.HasOne("BackendGobiernoIT.Models.SoftwareItem", "SoftwareItem")
                        .WithMany()
                        .HasForeignKey("SoftwareItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
